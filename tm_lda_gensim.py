...
def main():
    ...
    # nums_topics = range(4, 48, 4) # +44
    # nums_topics = range(48, 80, 4) # +32
    # nums_topics = range(80, 104, 4) # +24

    # nums_topics = range(2, 46, 4)
    # nums_topics = range(46, 78, 4)
    # nums_topics = range(78, 102, 4)

    nums_topics = [5]

    # alphas: 'symmetric' / <None>, 'asymmetric', 'auto', <Number>
    # alphas = [0.01, 0.1, 0.3, 1, 'symmetric', 'asymmetric', 'auto']
    alphas = ['auto']

    # betas: 'symmetric' / <None>, 'auto', <Number>
    # betas = [0.01, 0.1, 0.3, 1, 'symmetric', 'auto']
    betas = ['auto']
